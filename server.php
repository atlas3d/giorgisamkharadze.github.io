...
$arrayfuk = array(config('search_url'),config('category_url'),options('url_page'), options('url_movie'),options('url_imdb'), options('url_tvdb'),options('url_tv'),options('url_sport'),options('url_watch'),options('url_single'));
...
switch ($destination){
	...
	case options('url_video'):
		...
		break;
	case 'url_action':
		$goto =  DOCUMENT_ROOT.'/themes/'.config('sitethemes').'/'.$_GET['play'].'.php';
		break;
	case 'url_do':
